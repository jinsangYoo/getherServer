...
app.get('/testCSS.html', function (req, res) {
  console.log('GET call')
  console.log('***** req.headers: >>' + JSON.stringify(req.headers) + '<<')
  ...
  fs.readFile('./testCSS.html', function (error, data) {
    res.writeHead(200, {
      'Content-Type': 'text/html; charset=utf-8',
      'Accept-CH': 'UA, Platform',
    })
...
app.get('/testCSS2.html', function (req, res) {
  console.log('GET call')
  console.log('***** req.headers: >>' + JSON.stringify(req.headers) + '<<')
  ...
  fs.readFile('./testCSS2.html', function (error, data) {
    res.writeHead(200, {
      'Content-Type': 'text/html; charset=utf-8',
      'Accept-CH': 'UA, Platform',
    })
...
app.get('/testCSS3.html', function (req, res) {
  console.log('GET call')
  console.log('***** req.headers: >>' + JSON.stringify(req.headers) + '<<')
  ...
  fs.readFile('./testCSS3.html', function (error, data) {
    res.writeHead(200, {
      'Content-Type': 'text/html; charset=utf-8',
      'Accept-CH': 'UA, Platform',
    })
...
app.get('/policy', function (req, res) {
  ...
  console.log(
    '^^^^^^GET call: ' +
      d.toLocaleTimeString().red +
      ', ' +
      d.getMilliseconds().toString().green
  )
...
app.get(
  '/music/5/vote/favorite/vote/783/certificate/info',
  function (req, res) {
    console.log('GET call')
    console.log('***** req.headers: >>' + JSON.stringify(req.headers) + '<<')
...
app.get('/file/:filename', function (req, res) {
  ...
  const file = `${__dirname}/${params.filename}`
